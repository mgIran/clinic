...
/**
 * This is the model class for table "{{user_role_permissions}}".
 *
 * The followings are the available columns in table '{{user_role_permissions}}':
 * @property string $id
 ...
 */
class UserRolePermissions extends CActiveRecord
{
	/**
	 ...
	 * @return UserRolePermissions the static model class
	 */
