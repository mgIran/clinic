...
$this->menu=array(
    array('label'=>'مدیرت کاربران', 'url'=>array($user->role_id == 2?'adminPublishers':'admin')),
    array('label'=>'نمایش تراکنش های کاربر', 'url'=>array("userTransactions",'id'=>$user->id)),
    array('label'=>'بازگشت به اطلاعات کاربر', 'url'=>array('view', 'id' => $user->id))
);
?>
...
<!--        <h3>کتاب های این ناشر</h3>-->
<!--        <p class="description">کتاب هایی که --><?//= $user->userDetails->publication_name ?><!-- ناشر آنهاست.</p>-->
...
//    ?>
    <div class="white-form">
        ...
        <p class="description">کتاب هایی که خریداری کرده و هنوز دانلود نکرده</p>
        <?php
    ...
    <div class="white-form">
        <h3>دانلود شده ها</h3>
        <p class="description">کتاب هایی که دانلود کرده</p>
        <?php
        echo CHtml::beginForm($this->route,'GET',array('class' => 'form-inline form'));
        ?>
            <div class="filters">
    ...
    <div class="white-form">
        <h3>نشان شده ها</h3>
        <p class="description">کتاب هایی که نشان کرده</p>
        <?php
        echo CHtml::beginForm($this->route,'GET',array('class' => 'form-inline form'));
        ?>
            <?php
