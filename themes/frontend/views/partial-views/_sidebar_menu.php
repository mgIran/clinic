<?php if(isset(Yii::app()->user->clinic)):?>
    <?php if(Yii::app()->user->roles == 'clinicAdmin'):?>
        ...
        <a title="لیست نوبت های امروز" href="<?php echo Yii::app()->createUrl('/clinics/doctor/visits');?>" class="list-group-item<?php echo (Yii::app()->request->pathInfo=='clinics/doctor/visits')?' active':'';?>">لیست نوبت ها</a>
